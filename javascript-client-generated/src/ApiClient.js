...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    if (!root.SwaggerStore) {
      root.SwaggerStore = {};
    }
    root.SwaggerStore.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://virtserver.swaggerhub.com/EmilieLed/SellPlatform/1.0.0
     */
    this.basePath = 'https://virtserver.swaggerhub.com/EmilieLed/SellPlatform/1.0.0'.replace(/\/+$/, '');
