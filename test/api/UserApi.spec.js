...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.SellingPlatform);
  }
}(this, function(expect, SellingPlatform) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new SellingPlatform.UserApi();
  });
    ...
    describe('UserApi', function() {
      describe('addProduct', function() {
        it('should call addProduct successfully', function(done) {
          ...
          /*
          var body = new SellingPlatform.Product();
          body.id = "0";
          body.category = new SellingPlatform.Category();
          body.category.id = "0";
          body.category.name = "";
          body.title = "Lamp to sell";
          body.location = "London";
          body.photoUrls = [""];
          body.tags = [new SellingPlatform.Tag()];
          body.tags[0].id = "0";
          body.tags[0].name = "";
      ...
      describe('createUser', function() {
        it('should call createUser successfully', function(done) {
          ...
          /*
          var body = new SellingPlatform.User();
          body.id = "0";
          body.username = "";
          body.firstName = "";
          body.lastName = "";
        ...
        it('should call findProductsByTags successfully', function(done) {
          ...
          instance.findProductsByTags(tags, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(SellingPlatform.Product);
              expect(data.id).to.be.a('number');
              expect(data.id).to.be("0");
              expect(data.category).to.be.a(SellingPlatform.Category);
              ...
              }
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(SellingPlatform.Tag);
                  expect(data.id).to.be.a('number');
                  expect(data.id).to.be("0");
      ...
      describe('getUserByName', function() {
        it('should call getUserByName successfully', function(done) {
          ...
          instance.getUserByName(username, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(SellingPlatform.User);
            expect(data.id).to.be.a('number');
            expect(data.id).to.be("0");
      ...
      describe('uploadFile', function() {
        it('should call uploadFile successfully', function(done) {
          ...
          instance.uploadFile(productId, opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(SellingPlatform.ApiResponse);
